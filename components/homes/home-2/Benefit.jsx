            ...
            <div className="grid-img-group">
              <div className="tf-image-wrap item-1">
                <div className="img-style hover-img-wrap">
                  <Image
                    className="lazyload"
                    data-src="/images/banner/img-w-text-sm1.jpg"
                    alt=""
                    src="/images/banner/img-w-text-sm1.jpg"
                    width={484}
                    height={465}
                  />
                </div>
              ...
              <div className="tf-image-wrap item-3">
                <div className="img-style hover-img-wrap">
                  <Image
                    className="lazyload"
                    data-src="/images/banner/img-w-text-sm2.jpg"
                    alt=""
                    src="/images/banner/img-w-text-sm2.jpg"
                    width={370}
                    height={354}
                  />
                </div>
